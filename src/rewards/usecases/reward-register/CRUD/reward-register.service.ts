...
} from 'src/rewards/domains/reward-register.domain';
import { RewardRegisterRepositoryInterface } from 'src/rewards/repository/reward-register.repository.interface';
