...
import { CourseDomain } from 'src/courses/domains/course.domain'
import { CourseMapper } from 'src/courses/mappers/course.mappers'
  ...
  async remove(id: number): Promise<void> {
    ...
    if (!courseToRemove)
      throw new NotFoundException(
        {},
        { description: 'Curso não encontrado', cause: 'course.repository-remove' }
      )
