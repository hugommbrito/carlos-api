...
import { ModuleDomain } from 'src/courses/domains/module.domain'
import { ModuleMapper } from 'src/courses/mappers/module.mappers'
  ...
  async remove(id: number): Promise<void> {
    ...
    if (!moduleToRemove)
      throw new NotFoundException(
        {},
        { description: 'Módulo não encontrado', cause: 'module.repository-remove' }
      )
