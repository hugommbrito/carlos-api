...
import { Lecture } from 'src/courses/entity/lecture.entity'
import { LectureDomain } from 'src/courses/domains/lecture.domain'
import { LectureMapper } from 'src/courses/mappers/lecture.mappers'
import { Module } from 'src/courses/entity/module.entity'
  ...
  async remove(id: number): Promise<void> {
    ...
    if (!lectureToRemove)
      throw new NotFoundException(
        {},
        { description: 'Lecture not found', cause: 'lecture-repository-remove' }
      )
